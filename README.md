...
# Train the model
The provided pre-trained model requires approximately 10 hours on an RTX 3080 laptop GPU to complete 9e6 training steps. However, after 3–4 hours (around 3e6 steps), it already exhibits initial waveform generation capabilities. You can test the checkpoints using test_model.py.
