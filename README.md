...
(2) Leveraging SIES’s rich oscillatory modes and high-quality phase dynamics in networks of any size, it is directly applied as a graph neural network for node classification tasks. It achieves excellent performance on heterophilous graph datasets such as Roman-Empire. Notably, SIES-GNN can act like a “centrifuge,” continuously rotating the states of all nodes and segregating nodes of different classes into distinct spatial regions with different phase differences.
