...
(2) Leveraging SIES’s rich oscillatory modes and high-quality phase dynamics in networks of any size, it is directly applied as a graph neural network for node classification tasks. It achieves excellent performance on heterophilous graph datasets. Notably, SIES-GNN can act like a “centrifuge,” segregating nodes of different classes into distinct spatial regions with different phase differences during oscillations.
